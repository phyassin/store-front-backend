...
var modelUser = /** @class */ (function () {
    ...
    modelUser.prototype.createUser = function (u) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connect.query(sql, [u.first_name, u.last_name, passHash(u.password)])];
                    case 2:
                        result = _a.sent();
                        connect.release();
    ...
    modelUser.prototype.authenticate = function (first_name, last_name, password) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, passHash_1, info, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        passHash_1 = result.rows[0].password;
                        if (!bcrypt_1.default.compareSync("".concat(password).concat(config_1.default.pepper), passHash_1)) return [3 /*break*/, 4];
    ...
    modelUser.prototype.updateUser = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connect.query(sql, [u.id, u.first_name, u.last_name, passHash(u.password)])];
                    case 2:
                        result = _a.sent();
                        connect.release();
                        return [2 /*return*/, result.rows[0]];
